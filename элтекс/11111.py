...
def output_of_statistics_for_the_day(): 
    ...
    plt.rcParams['figure.figsize'] = [10, 10]# размер графиков 
...
thr1 = threading.Thread(target = Loading)
thr1.start()

thr2 = threading.Thread(target = output_of_statistics_for_the_day)
thr2.start()
